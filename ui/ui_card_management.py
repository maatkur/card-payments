...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon1 = QIcon()
        icon1.addFile(f"{os.getenv('ICONS_PATH')}icons8-pesquisar-60.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.search_button.setIcon(icon1)
        self.search_button.setIconSize(QSize(34, 60))
        ...
        self.clear_filters_button.setGeometry(QRect(680, 56, 62, 40))
        icon2 = QIcon()
        icon2.addFile(f"{os.getenv('ICONS_PATH')}filtro-limpo.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.clear_filters_button.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(f"{os.getenv('ICONS_PATH')}icons8-salvar-96.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(f"{os.getenv('ICONS_PATH')}delete.ico", QSize(), QIcon.Normal, QIcon.Off)
