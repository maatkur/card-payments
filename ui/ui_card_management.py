...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon2 = QIcon()
        icon2.addFile(u"icons/filtro-limpo.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"icons/icons8-salvar-96.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"icons/delete.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"icons/excel.ico", QSize(), QIcon.Normal, QIcon.Off)
