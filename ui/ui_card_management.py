...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon3 = QIcon()
        icon3.addFile(f"{getenv('ICONS_PATH')}icons8-salvar-96.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(f"{getenv('ICONS_PATH')}delete.ico", QSize(), QIcon.Normal, QIcon.Off)
