...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.excel_initial_date.setGeometry(QRect(0, 25, 91, 22))
        font = QFont()
        ...
        self.excel_search_button.setGeometry(QRect(100, 23, 75, 25))
        ...
        self.clear_button.setGeometry(QRect(1130, 20, 75, 24))
        ...
        self.unconciliated_initial_date.setGeometry(QRect(0, 22, 91, 22))
        ...
        self.unconciliated_final_date.setGeometry(QRect(100, 22, 91, 22))
        ...
        self.unconciliated_search_button.setGeometry(QRect(200, 20, 75, 25))
        self.unconciliated_tab = QTabWidget(self.frame_3)
        self.unconciliated_tab.setObjectName(u"unconciliated_tab")
        self.unconciliated_tab.setGeometry(QRect(0, 50, 1231, 291))
        font2 = QFont()
        font2.setBold(True)
        self.unconciliated_tab.setFont(font2)
        ...
        self.unconciliated_table.setGeometry(QRect(0, 0, 1225, 261))
        ...
        font3.setBold(True)
        self.total_conciliation_label_2.setFont(font3)
        ...
        self.total_unconciliated_label.setGeometry(QRect(375, 318, 241, 20))
        self.total_unconciliated_label.setFont(font3)
        ...
        self.conciliation_tab.setGeometry(QRect(0, 0, 1231, 291))
        self.conciliation_tab.setFont(font2)
        ...
        self.not_found_table.setGeometry(QRect(0, 0, 1002, 261))
        ...
        self.total_conciliation_label.setGeometry(QRect(560, 270, 201, 20))
        self.total_conciliation_label.setFont(font3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.clear_button.setText(QCoreApplication.translate("MainWindow", u"Limpar", None))
        ...
        ___qtablewidgetitem12.setText(QCoreApplication.translate("MainWindow", u"Data do cr\u00e9dito", None));
        ...
        ___qtablewidgetitem26.setText(QCoreApplication.translate("MainWindow", u"Data do cr\u00e9dito", None));
        ...
        ___qtablewidgetitem40.setText(QCoreApplication.translate("MainWindow", u"Data do cr\u00e9dito", None));
