...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(f"{getenv('ICONS_PATH')}refresh.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(f"{getenv('ICONS_PATH')}excel.ico", QSize(), QIcon.Normal, QIcon.Off)
        self.excel_button.setIcon(icon2)
        self.search_button = QPushButton(self.frame_2)
        self.search_button.setObjectName(u"search_button")
        self.search_button.setGeometry(QRect(310, 38, 80, 25))
        icon3 = QIcon()
        icon3.addFile(f"{getenv('ICONS_PATH')}icons8-pesquisar-60.ico", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(f"{getenv('ICONS_PATH')}filtro-limpo.ico", QSize(), QIcon.Normal, QIcon.Off)
